...
class ServiceProviderFinanceView
    extends StackedView<ServiceProviderFinanceViewModel> {
  const ServiceProviderFinanceView({Key? key}) : super(key: key);

  @override
  Widget builder(BuildContext context,
      ServiceProviderFinanceViewModel viewModel, Widget? child) {
    return Scaffold(
  ...
  @override
  ServiceProviderFinanceViewModel viewModelBuilder(BuildContext context) =>
      ServiceProviderFinanceViewModel();
