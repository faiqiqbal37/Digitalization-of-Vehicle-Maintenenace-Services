...
final Map<String, TextEditingController>
    _ServiceProviderAddServiceViewTextEditingControllers = {};

final Map<String, FocusNode> _ServiceProviderAddServiceViewFocusNodes = {};

final Map<String, String? Function(String?)?>
    _ServiceProviderAddServiceViewTextValidations = {
...
mixin $ServiceProviderAddServiceView {
  ...
  TextEditingController _getFormTextEditingController(
    ...
    if (_ServiceProviderAddServiceViewTextEditingControllers.containsKey(key)) {
      return _ServiceProviderAddServiceViewTextEditingControllers[key]!;
    }

    _ServiceProviderAddServiceViewTextEditingControllers[key] =
        TextEditingController(text: initialValue);
    return _ServiceProviderAddServiceViewTextEditingControllers[key]!;
  }

  FocusNode _getFormFocusNode(String key) {
    if (_ServiceProviderAddServiceViewFocusNodes.containsKey(key)) {
      return _ServiceProviderAddServiceViewFocusNodes[key]!;
    }
    _ServiceProviderAddServiceViewFocusNodes[key] = FocusNode();
    return _ServiceProviderAddServiceViewFocusNodes[key]!;
  }
  ...
  void disposeForm() {
    ...
    for (var controller
        in _ServiceProviderAddServiceViewTextEditingControllers.values) {
      controller.dispose();
    }
    for (var focusNode in _ServiceProviderAddServiceViewFocusNodes.values) {
      focusNode.dispose();
    }

    _ServiceProviderAddServiceViewTextEditingControllers.clear();
    _ServiceProviderAddServiceViewFocusNodes.clear();
  }
}
...
extension ValueProperties on FormStateHelper {
  ...
  set serviceNameValue(String? value) {
    ...
    if (_ServiceProviderAddServiceViewTextEditingControllers.containsKey(
        ServiceNameValueKey)) {
      _ServiceProviderAddServiceViewTextEditingControllers[ServiceNameValueKey]
          ?.text = value ?? '';
    }
  }
  ...
  set descriptionValue(String? value) {
    ...
    if (_ServiceProviderAddServiceViewTextEditingControllers.containsKey(
        DescriptionValueKey)) {
      _ServiceProviderAddServiceViewTextEditingControllers[DescriptionValueKey]
          ?.text = value ?? '';
    }
  }
  ...
  set priceValue(String? value) {
    ...
    if (_ServiceProviderAddServiceViewTextEditingControllers.containsKey(
        PriceValueKey)) {
      _ServiceProviderAddServiceViewTextEditingControllers[PriceValueKey]
          ?.text = value ?? '';
    }
  }
  ...
  set etaValue(String? value) {
    ...
    if (_ServiceProviderAddServiceViewTextEditingControllers.containsKey(
        EtaValueKey)) {
      _ServiceProviderAddServiceViewTextEditingControllers[EtaValueKey]?.text =
          value ?? '';
    }
  }
...
String? getValidationMessage(String key) {
  final validatorForKey = _ServiceProviderAddServiceViewTextValidations[key];
  if (validatorForKey == null) return null;

  String? validationMessageForKey = validatorForKey(
    _ServiceProviderAddServiceViewTextEditingControllers[key]!.text,
  );
